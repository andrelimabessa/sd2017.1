...
try:
    ...
    while True:
        ...
        # carrega um jogo salvo e envia para o cliente
            ...
            linha = int(linha2[0])  # pega a primeira posição e joga em linha
            coluna = int(linha2[1])  # pega a segunda posição e joga em coluna
            ...
            arq.close()
            dados = int(linha1), campo, campSobrePosto  # retorna as jogadas e os campos
