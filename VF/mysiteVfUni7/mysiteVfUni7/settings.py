"""
Django settings for mysiteVfUni7 project.
...
SECRET_KEY = '$qk(qvbq94^^8pey5w5&gpv5yo(7dmnspa7tzfhnihh-3v1^m%'
...
ROOT_URLCONF = 'mysiteVfUni7.urls'
...
WSGI_APPLICATION = 'mysiteVfUni7.wsgi.application'
